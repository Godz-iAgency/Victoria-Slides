...
const icon = (name) => ({
  ...
  reader: '<svg viewBox="0 0 24 24"><path d="M3.5 5.5c2.8-.9 5.7-.3 8.5 1.8v12c-2.8-2.1-5.7-2.7-8.5-1.8v-12Z"/><path d="M20.5 5.5c-2.8-.9-5.7-.3-8.5 1.8v12c2.8-2.1 5.7-2.7 8.5-1.8v-12Z"/></svg>',
